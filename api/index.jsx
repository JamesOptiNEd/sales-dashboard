...
function defTargets() {
  return {
    ...
    Susanna: { sub: 0,      lic: 0 },
    // James: Director of Europe — retained personal key accounts in both brands
    // since the promotion. No individual target figure provided yet, so this
    // defaults to 0; his Achieved and Pipeline will still populate correctly
    // from HubSpot regardless. Update once his personal target is confirmed.
    James:   { sub: 0,      lic: 0 },
...
const STORAGE_KEY='opti_dashboard_targets_v5';
