...
function PostCard({ postId, header, subheader, big, bigColor, accent, social, yourName, onReact, onComment }) {
  ...
  return (
    <div style={{background:'#fff',border:'1px solid #E0E4EC',borderRadius:12,padding:'14px 16px',marginBottom:10}}>
